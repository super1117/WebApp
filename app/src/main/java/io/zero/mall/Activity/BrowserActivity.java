...
import io.zero.mall.Browser.AlbumController;
import io.zero.mall.Browser.BrowserContainer;
import io.zero.mall.Browser.BrowserController;
import io.zero.mall.Service.ClearService;
import io.zero.mall.Task.ScreenshotTask;
import io.zero.mall.Database.Record;
import io.zero.mall.Database.RecordAction;
import io.zero.mall.Service.HolderService;
import io.zero.mall.Unit.BrowserUnit;
import io.zero.mall.Unit.IntentUnit;
import io.zero.mall.Unit.ViewUnit;
import io.zero.mall.View.*;
...
public class BrowserActivity extends Activity implements BrowserController {
    ...
    private final static String WEB_URL = "https://www.353mall.com/mobile/";
    ...
    private void initOmnibox() {
        ...
        inputBox.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                updateAlbum("https://www.353mall.com/mobile/");
                hideSoftInput(inputBox);
                return false;
            }
        });
...
//        }, 1000);
    ...
    private void initHomeGrid(final NinjaRelativeLayout layout, boolean update) {
        ...
        aboutBlank.setVisibility(View.GONE);
